...
arguments_strFirst = 'a.png'
arguments_strSecond = 'b.png'
...
class Network(torch.nn.Module):
	def __init__(self):
		...
		self.load_state_dict(torch.load('../pretrained_models/network-' + arguments_strModel + '.pytorch'))
	# end
...
def estimate(moduleNetwork, tensorFirst, tensorSecond):
	...
	tensorFlow = 20.0 * torch.nn.functional.interpolate(input=tensorFlow, size=(intHeight, intWidth), mode='bilinear', align_corners=True)
